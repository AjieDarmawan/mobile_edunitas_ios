...
List<ListDonasiModel> listDonasiModelFromJson(String str) => List<ListDonasiModel>.from(json.decode(str).map((x) => ListDonasiModel.fromJson(x)));

String listDonasiModelToJson(List<ListDonasiModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ListDonasiModel {
    ListDonasiModel({
        this.nama,
        this.medsos,
        this.aboutme,
    ...
    factory ListDonasiModel.fromJson(Map<String, dynamic> json) => ListDonasiModel(
        ...
        terkumpul: json["terkumpul"] == null ? null : json["terkumpul"],
        persentase: json["persentase"] == null ? null : json["persentase"].toDouble(),
