...
DonasiListModel detailDonasiListModelFromJson(String str) =>
    DonasiListModel.fromJson(json.decode(str));

String detailDonasiListModelToJson(DonasiListModel data) =>
    json.encode(data.toJson());

class DonasiListModel {
  DonasiListModel({
    this.judul,
    this.seolink,
    this.status,
  ...
  factory DonasiListModel.fromJson(Map<String, dynamic> json) =>
      DonasiListModel(
        ...
        persentase: json["persentase"] == null ? null : json["persentase"],
