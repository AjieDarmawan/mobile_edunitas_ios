...
class _MainHomeState extends State<MainHome> with TickerProviderStateMixin {
  ...
  Future<List<BannerModel>> getBanner() async {
    final response = await http.get(ConstanUrl().baseUrl + "banner");
  ...
  countread(globalkey1) {
    Kampusview_model().count_read(globalkey1.toString()).then((value) {//handled
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      height: 100,
                      width: double.infinity,
                      child: MenuHome(keycode : globalkey.toString() == null ? "" : globalkey.toString()),
                    ),
            ...
            AnimatedBuilder(
              ...
              builder: (context, child) => Container(
                ...
                child: SafeArea(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [_buildLogo(), _buildSearch(), _buildIcon()],
                  ),
                ),
              ),
            ),
