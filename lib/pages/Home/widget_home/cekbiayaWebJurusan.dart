...
class _CekbiayaWebJurusanState extends State<CekbiayaWebJurusan> {
  ...
  void getSipemaWhereKelompok(kode_kampus, kode_jurusan, kodeprogram) {
    KarirViewModel()
      ...
      setState(() {
        ...
        programstudi2 = first_lulusan.toString();
      ...
      print("first_lulusan 2" + first_lulusan);
    }).catchError((erro){
      onErrHandling(erro);
    });
  }
  ...
  void getSipemaWhereprogram(kode_kampus, kode_jurusan) {
    KarirViewModel()
      ...
      setState(() {
        ...
        programstudi3 = datasipemaprogram[0].nama;
  ...
  void getBiayaSipemaAngsurSpb() {
    print("sipema_program_kode" + sipema_program_kode.toString());
    // print("get_spb_campus" + widget.campus.kode.toString());
    // print("get_spb_kodejurusan" + widget.kodejurusan.toString());
    sipemaview_model()
  ...
  var programstudi2 = "Loading...";
  var programstudi3 = "Loading...";
  ...
  void getData() {
    ...
    setState(() {
      ...
      // print("first_lulusan" + first_lulusan);
      //  print("first_lulusan" + widget.kodejurusan);
      //   print("first_lulusan" + widget.campus.kode);

      // biayajaket = namajaket.toString();
      // programstudilulusan = namalulusan.toString();
      // biayaSpp = namaspp;
      // biayaSpb = namaspb;
      // biayapendaftaran = namaformulir.toString();
      // angsuranselanjutnya = int.parse(bulanan);
      // angsuranpertama = biayaSpp +
      //     biayaSpb +
      //     //int.parse(biayapendaftaran) +
      //     int.parse(biayajaket);
  ...
  Widget build(BuildContext context) {
    ...
    //print("dataAngsurSpb${dataAngsurSpb}");
    print("sipema_program_kode" + sipema_program_kode.toString());
    print("sipema_program_kode" + sipema_program_kode.toString());
    return Scaffold(
      appBar: AppBar(
