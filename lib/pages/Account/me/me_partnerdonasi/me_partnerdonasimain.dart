                  ...
                  Expanded(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => (DonasiDataCampaigner(
                                    edit: false,
                                                          ...
                                                          onPressed: () {
                                                            Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder:
                                                                        (context) =>
                                                                            (DonasiDataCampaigner(
                                                                              edit: true,
                                                                              seolink: _konten.seolink.toString(),
                                                                              keyCode: widget.keycode,
                                                                            ))));
                                                          }),
                                                    )
                                                                    ...
                                                                    EduButtonSecond(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          Navigator
                                                                            ...
                                                                            context,
                                                                            MaterialPageRoute(
                                                                                builder: (context) => (DonasiListDetail(
                                                                                      seolink: _konten.seolink.toString() == null ? "" : _konten.seolink.toString(),
                                                                                      keycode: widget.keycode,
                                                                                    ))),
                                                                          );
                                                                        }),
