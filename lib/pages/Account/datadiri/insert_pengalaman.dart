...
class PenglamanDatadiri extends StatefulWidget {
  ...
  @override
  _PenglamanDatadiriState createState() => _PenglamanDatadiriState();
}

class _PenglamanDatadiriState extends State<PenglamanDatadiri> {
  TextEditingController etperusahaan = new TextEditingController();
  TextEditingController etgajibulanan = new TextEditingController();
  TextEditingController etalamat = new TextEditingController();
  TextEditingController etdeskripsi = new TextEditingController();
...
class ContentModalState extends State<ContentModal>{
  ...
  TextEditingController etsearchjurusan = new TextEditingController();

  List<SpesialisasiModel> fdataList = [];
  List<SpesialisasiModel> dataList = [];
  List<MasterDaerahModel> fdataListwilayah = [];
  List<MasterDaerahModel> dataListwilayah = [];
  List<MasterJurusanModel> fdataListJurusan = [];
  List<MasterJurusanModel> dataListJurusan = [];
  List<String> result = ["", ""];
            ...
            Container(
              child: Expanded(
                ...
                Column(
                  ...
                  itemCount: lenght,
                  itemBuilder: (BuildContext context, int index) {
                    final fdata = fdataListJurusan[index];
                    return InkWell(
                      onTap: () {
                        setState(() {
                          //print("valpos: "+lastDataSipema.id.toString()+"&&"+lastDataSipema.nama);
